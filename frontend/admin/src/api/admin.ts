...
export const adminAPI = {
  ...
  getNewUserPurchaseDefault: () => api.get('/admin/users/purchase-default'),
  updateNewUserPurchaseDefault: (enabled: boolean) => api.put('/admin/users/purchase-default', { enabled }),
